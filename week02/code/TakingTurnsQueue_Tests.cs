...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue currently adds new people to the wrong end of the queue, causing LIFO behavior instead of FIFO.
    ...
    // Defect(s) Found: FIFO order is broken because enqueue inserts at the wrong end of the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite-turn people are not re-enqueued when turns are 0 or less.
